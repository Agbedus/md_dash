      ...
      <div className="flex w-full">
        ...
        <div className="hidden lg:flex lg:w-1/2 relative bg-foreground/[0.02] overflow-hidden border-r border-card-border">
          ...
          <div className="absolute inset-0 pointer-events-none opacity-50">
            <div className="absolute top-[20%] right-[-10%] w-[70%] h-[70%] rounded-full bg-emerald-500/10 blur-[120px] animate-pulse-soft" />
            <div className="absolute top-[-10%] left-[-10%] w-[60%] h-[60%] rounded-full bg-indigo-500/10 blur-[100px] animate-pulse-soft" style={{ animationDelay: '1s' }} />
          </div>
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative">
          ...
          <div className="relative w-full max-w-md p-10 space-y-8 bg-background border border-card-border rounded-3xl shadow-2xl z-10">
            <div className="text-center space-y-2">
              ...
              <h1 className="text-4xl font-extrabold text-foreground tracking-tight">Join Platform</h1>
              <p className="text-text-muted font-bold uppercase tracking-widest text-[10px]">
                Initiate administrative enrollment
              </p>
            </div>
            <RegisterForm />
          </div>
