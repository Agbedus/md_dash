        ...
        <div className="min-h-screen bg-background flex flex-col">
            ...
            <div className="h-16 px-6 border-b border-card-border bg-background/40 backdrop-blur-md flex items-center justify-between sticky top-0 z-50">
                <div className="flex items-center gap-6">
                    <Link href="/projects" className="p-2 rounded-xl bg-foreground/[0.03] hover:bg-foreground/[0.06] text-text-muted hover:text-foreground transition-all border border-card-border">
