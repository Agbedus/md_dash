        ...
        <div className="min-h-screen bg-zinc-950 flex flex-col">
            ...
            <div className="h-16 px-6 border-b border-white/5 bg-zinc-900/40 backdrop-blur-md flex items-center justify-between sticky top-0 z-50">
                <div className="flex items-center gap-6">
                    <Link href="/projects" className="p-2 rounded-xl bg-white/[0.03] hover:bg-white/[0.06] text-zinc-400 hover:text-white transition-all border border-white/5">
                    ...
                    <div className="flex flex-col">
                        ...
                        <h1 className="text-lg font-medium text-white tracking-tight uppercase leading-none">{project.name}</h1>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                    <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-white/[0.03] border border-white/5">
                        ...
                        <span className="text-[11px] font-medium text-white uppercase tracking-wider">Active System</span>
                    </div>
                    <button className="flex items-center gap-2 h-10 px-4 rounded-xl bg-white/[0.03] hover:bg-white/[0.06] border border-white/5 text-[11px] font-medium text-zinc-400 uppercase tracking-wider transition-all">
            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                <div className="w-64 border-r border-white/5 bg-zinc-900/20 p-5 flex flex-col gap-6 hidden lg:flex">
                    <div className="space-y-1">
                        <p className="px-4 text-[11px] font-medium text-zinc-600 uppercase tracking-wider mb-3">Navigation</p>
                    ...
                    <div className="space-y-1">
                        <p className="px-4 text-[11px] font-medium text-zinc-600 uppercase tracking-wider mb-3">Health Status</p>
                        <div className="px-4 py-3 rounded-2xl bg-white/[0.03] border border-white/5 space-y-3">
                            <div className="flex items-center justify-between">
                                <span className="text-[11px] font-bold text-zinc-500 uppercase tracking-tight">Tactical Health</span>
                            ...
                            <div className="flex items-center justify-between">
                                <span className="text-[11px] font-bold text-zinc-500 uppercase tracking-tight">Resources</span>
                                <span className={`text-[11px] font-medium uppercase tracking-wider ${
                    ...
                    <div className="px-6 py-8 max-w-[1600px] mx-auto space-y-8">
                                    ...
                                    <div className="xl:col-span-2 space-y-6">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <div className="glass rounded-2xl p-6 border border-white/5 bg-zinc-900/10 flex flex-col gap-6">
                                                <h3 className="text-[11px] font-medium text-white uppercase tracking-wider flex items-center gap-3">
                                                ...
                                                <div className="flex items-center gap-6">
                                                    <div className="relative w-20 h-20 flex-shrink-0">
                                                        ...
                                                        <div className="absolute inset-0 flex flex-col items-center justify-center">
                                                            <span className="text-sm font-medium text-white leading-none">{Math.round(taskProgress)}%</span>
                                                        </div>
                                                    </div>
                                                    <div className="flex-1 space-y-4">
                                                        <div>
                                                            <p className="text-[11px] font-medium text-zinc-600 uppercase tracking-wider mb-2">Project Brief</p>
                                        ...
                                        <div className="space-y-4">
                                            <div className="flex items-center justify-between">
                                                ...
                                                <button onClick={() => setActiveView('tasks')} className="text-[11px] font-medium text-zinc-500 hover:text-white uppercase tracking-wider transition-colors flex items-center gap-2">
                                                    ...
                                                    <table className="w-full text-left">
                                                        <thead>
                                                            <tr className="border-b border-white/5 bg-white/[0.02]">
                                                                <th className="px-6 py-3 text-[11px] font-medium text-zinc-500 uppercase tracking-wider">Name</th>
                                                                <th className="px-6 py-3 text-[11px] font-medium text-zinc-500 uppercase tracking-wider">Assignee</th>
                                                                <th className="px-6 py-3 text-[11px] font-medium text-zinc-500 uppercase tracking-wider">Status</th>
                                                            </tr>
                                                        </thead>
                                                                ...
                                                                <tr key={task.id} className="hover:bg-white/[0.03] transition-colors">
                                                                    ...
                                                                    <td className="px-6 py-3">
                                                                        {task.assignees && task.assignees.length > 0 ? (
                                                                            ...
                                                                            <span className="text-[11px] font-bold text-zinc-700 uppercase tracking-wider">Unassigned</span>
                                                                        )}
                                                                    </td>
                                                                    <td className="px-6 py-3">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            ...
                                            <div className="glass rounded-2xl p-6 border border-white/5 bg-zinc-900/10 flex flex-col gap-4">
                                                ...
                                                <div className="space-y-4">
                                                    <div className="flex items-center justify-between">
                                                        <span className="text-[11px] font-bold text-zinc-500 uppercase tracking-wider">Allocation</span>
                                                        <span className="text-[11px] font-medium text-white uppercase tracking-wider">${(project.budget || 0).toLocaleString()}</span>
                                                    </div>
                                                    <div className="w-full h-8 bg-white/[0.03] rounded-xl border border-white/5 relative overflow-hidden flex">
                                                        <div className="h-full bg-emerald-500/40" style={{ width: `${Math.min(budgetProgress, 100)}%` }} />
                                                        <div className="absolute inset-0 flex items-center justify-center">
                                                            <span className="text-[11px] font-medium text-white uppercase tracking-wider">{Math.round(budgetProgress)}% Exhausted</span>
                                                        </div>
                                                    </div>
                                                    <div className="grid grid-cols-2 gap-4">
                                                        <div className="p-3 rounded-xl bg-white/[0.03] border border-white/5">
                                                            <p className="text-[11px] font-bold text-zinc-500 uppercase tracking-wider mb-1">Spent</p>
                                                            <p className="text-xs font-medium text-white">${(project.spent || 0).toLocaleString()}</p>
                                                        </div>
                                                        <div className="p-3 rounded-xl bg-white/[0.03] border border-white/5">
                                                            <p className="text-[11px] font-bold text-zinc-500 uppercase tracking-wider mb-1">Available</p>
                                                            <p className="text-xs font-medium text-emerald-400">${((project.budget || 0) - (project.spent || 0)).toLocaleString()}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="glass rounded-2xl p-6 border border-white/5 bg-zinc-900/10 space-y-4">
                                            ...
                                            <div className="p-4 rounded-xl bg-white/[0.03] border border-white/5 space-y-3">
                                                <div>
                                                    <p className="text-[11px] font-medium text-zinc-600 uppercase tracking-wider mb-1">Entity</p>
                                                    <p className="text-sm font-medium text-white uppercase tracking-tight">{client ? client.companyName : 'Internal Asset'}</p>
                                                </div>
                                                <div className="grid grid-cols-2 gap-4">
                                                    <div>
                                                        <p className="text-[11px] font-medium text-zinc-600 uppercase tracking-wider mb-1">Entity</p>
                                                        <p className="text-[11px] font-medium text-zinc-400 uppercase tracking-wider">{client?.companyName || 'Classified'}</p>
                                                    </div>
                                                    <div>
                                                        <p className="text-[11px] font-medium text-zinc-600 uppercase tracking-wider mb-1">Contact</p>
                                                        <p className="text-[11px] font-medium text-zinc-400 uppercase tracking-wider">{client?.contactPersonName || 'Unassigned'}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="glass rounded-2xl p-6 border border-white/5 bg-zinc-900/10 space-y-6">
                                            ...
                                            <div className="flex flex-wrap gap-2.5">
                                                ...
                                                <button className="w-10 h-10 rounded-full border border-white/5 border-dashed flex items-center justify-center text-zinc-600 hover:text-white hover:border-white hover:bg-white/[0.03] transition-all">
                                                    <FiPlus className="w-4 h-4" />
                                                </button>
                                            </div>
                                            <div className="pt-2 border-t border-white/5">
                                                <p className="text-[11px] font-bold text-zinc-500 uppercase tracking-wider text-center">Authorized Personnel: {users.length}</p>
                                            </div>
                                        </div>
                        ...
                        {activeView === 'tasks' && (
                            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
                                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                                    <div>
                                        <h2 className="text-2xl font-medium text-white uppercase tracking-tight leading-none">Operation Center</h2>
                                        <p className="text-[11px] font-medium text-zinc-500 uppercase tracking-wider mt-2">{tasks.length} Active Maneuvers Identified</p>
                                    </div>
                                    <div className="flex items-center gap-4">
                                        <div className="flex bg-white/[0.03] p-1 rounded-2xl border border-white/5">
                                            <button className="h-10 px-6 rounded-xl bg-white/[0.06] text-white text-[11px] font-medium uppercase tracking-wider transition-all">Table</button>
                                            <button className="h-10 px-6 rounded-xl text-zinc-500 hover:text-zinc-300 text-[11px] font-medium uppercase tracking-wider transition-all">Kanban</button>
                                        </div>
                                        <button className="flex items-center gap-2 h-12 px-8 rounded-2xl bg-white/[0.03] hover:bg-white/[0.06] border border-white/5 text-white text-[11px] font-medium uppercase tracking-wider transition-all">
                                            <FiPlus className="w-4 h-4" />
                        ...
                        {activeView === 'notes' && (
                            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
                                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                                    <div>
                                        <h2 className="text-2xl font-medium text-white uppercase tracking-tight leading-none">Intelligence Hub</h2>
                                        <p className="text-[11px] font-medium text-zinc-500 uppercase tracking-wider mt-2">Classified briefings and metadata</p>
                                    </div>
                                    <button className="flex items-center gap-2 h-12 px-8 rounded-2xl bg-white/[0.03] hover:bg-white/[0.06] border border-white/5 text-white text-[11px] font-medium uppercase tracking-wider transition-all">
                                        <FiPlus className="w-4 h-4" />
                                        <span>Log Note</span>
    ...
    return (
        <div className="flex flex-col gap-2 group">
            <div className="flex items-center gap-2">
                ...
                <span className={`text-[11px] font-medium uppercase tracking-wider ${status === 'pending' ? 'text-zinc-600' : 'text-zinc-400'}`}>{date}</span>
            </div>
            <p className={`text-sm font-medium uppercase tracking-tight transition-colors ${status === 'pending' ? 'text-zinc-700' : 'text-white group-hover:text-indigo-400'}`}>{label}</p>
        </div>
    );
}
    ...
    return (
        <div className="space-y-2.5">
            <div className="flex items-center justify-between">
                ...
                <span className={`text-[11px] font-medium uppercase tracking-wider ${percentage < 30 ? 'text-emerald-400' : percentage > 70 ? 'text-amber-400' : 'text-indigo-400'}`}>{value}</span>
            </div>
...
function NavButton({ active, onClick, icon: Icon, label }: { active: boolean, onClick: () => void, icon: any, label: string }) {
    return (
        <button 
            onClick={onClick}
            className={`w-full flex items-center gap-4 px-4 py-2.5 rounded-xl text-[11px] font-medium uppercase tracking-wider transition-all ${
                active 
                    ? 'bg-white/[0.06] text-white border border-white/5' 
                    : 'text-zinc-500 hover:text-zinc-300 hover:bg-white/[0.03] border border-transparent blur-[0.3px] hover:blur-none'
            }`}
        >
    ...
    return (
        <div className="flex items-center gap-3 group">
            ...
            <div className="flex-1 min-w-0">
                <p className="text-[11px] font-medium text-white uppercase tracking-tight truncate">
                    <span className="text-zinc-500 font-bold">{(user.fullName || 'User').split(' ')[0]}</span> {action} <span className="text-indigo-400">{target}</span>
                </p>
                <p className="text-[11px] font-bold text-zinc-700 uppercase tracking-wider mt-0.5">{time}</p>
            </div>
        </div>
    );
}
            ...
            <div className="flex flex-col gap-4 relative z-10">
                ...
                <div>
                    ...
                    <div className="flex items-baseline gap-2">
                        <span className="text-xl font-medium text-white uppercase tracking-tight">{value}</span>
                        <span className="text-[11px] font-bold text-zinc-600 uppercase tracking-wider">{subValue}</span>
                    </div>
                </div>
            </div>
        </div>
