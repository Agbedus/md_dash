...
export function CommandMenu({ open, setOpen }: CommandMenuProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-start justify-center pt-[20vh] px-4">
      ...
      {/* Dialog */}
      <div className="relative w-full max-w-lg overflow-hidden rounded-xl border border-white/5 bg-zinc-900 shadow-2xl animate-in fade-in zoom-in-95 duration-200">
        <Command className="w-full bg-transparent">
          ...
          <Command.List className="max-h-[300px] overflow-y-auto overflow-x-hidden p-2 scrollbar-hide">
            ...
            <Command.Group heading="Navigation" className="text-xs font-medium text-zinc-500 px-2 py-1.5">
              <Command.Item
                ...
                className="relative flex cursor-pointer select-none items-center rounded-lg px-2 py-2 text-sm text-zinc-400 hover:bg-white/[0.03] hover:text-white aria-selected:bg-white/[0.03] aria-selected:text-white transition-colors"
              >
            ...
            <Command.Separator className="my-1 h-px bg-white/[0.03]" />
          ...
          <div className="border-t border-white/5 px-2 py-2 flex items-center justify-between text-[11px] text-zinc-500">
             <div className="flex items-center gap-1">
                <kbd className="pointer-events-none inline-flex h-5 select-none items-center gap-1 rounded border border-white/5 bg-white/[0.03] px-1.5 font-mono font-medium opacity-100">
